        ...
        var a = Symbol("onSliderInput"),
            i = function(e) {
                function i(e) {
                    ...
                    return n._clickEvents = ["click"], n.options = u({}, o.a, t), n[a] = n[a].bind(n), n.init(), n
                }
                return function(e, t) {
                    ...
                    value: function() {
                        var e, t = window.getComputedStyle(this.element, null),
                    ...
                    value: function(e) {
                        ...
                        this.output.value = n + this.element.value + r, this.emit("bulmaslider:ready", this.element.value)
                    }
                }], [{
                    key: "attach",
                    value: function() {
                ...
                value: function(n, r) {
                    ...
                    if (Array.isArray(u))
                        for (u.forEach(function(e, t) {
                                ...
                                }), a >= l.length && (s = !0)) : s = !0), s && (e.once && (u[t] = null), e.callback(r))
                            }); - 1 !== u.indexOf(null);) u.splice(u.indexOf(null), 1)
                }
            }]), t
        }();
        t.a = i
